#
#  Be sure to run `pod spec lint ImageBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "TCS" => "1126270643@qq.com" }
  # Or just: s.author    = "TCS"
  # s.authors            = { "TCS" => "1126270643@qq.com" }
  # s.social_media_url   = "http://twitter.com/TCS"
